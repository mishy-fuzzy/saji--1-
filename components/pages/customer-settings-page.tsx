            ...
            <Card className="border-0 shadow-sm overflow-hidden sticky top-20">
              <nav className="p-1.5">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors"
                >
                        ...
                        {languages.map((lang) => (
                          ...
                          >
                            <div className="flex items-center gap-2.5">
                              <span className="w-7 h-5 bg-muted rounded text-[10px] font-bold flex items-center justify-center text-muted-foreground">
                                {lang.flag}
                              </span>
                ...
                <Card className="p-5 border-0 shadow-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      onClick={() =>
                        alert(
                          "Enable 2FA functionality would be implemented here",
                        )
                      }
                      variant="outline"
                      size="sm"
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {themes.map((t) => {
                    ...
                    return (
                      ...
                      >
                        <Icon
                          className={`w-8 h-8 mb-3 ${theme === t.id ? "text-primary" : "text-muted-foreground"}`}
                        />
                ...
                <Card className="p-5 border-0 shadow-sm">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-3.5 bg-muted/50 rounded-xl">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-7 bg-emerald-600 rounded-lg flex items-center justify-center text-white font-bold text-[9px]">
                          M-PESA
                        </div>
                        <div>
                          <p className="font-medium text-sm text-foreground">
                      ...
                      <span className="text-[11px] bg-emerald-100 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 px-2 py-0.5 rounded-md font-semibold">
                        Default
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-3.5 bg-muted/50 rounded-xl">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-7 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-[9px]">
                          VISA
                        </div>
                        <div>
                          <p className="font-medium text-sm text-foreground">
                      ...
                      <Button
                        onClick={() =>
                          alert(
                            "Remove payment method functionality would be implemented here",
                          )
                        }
                        variant="ghost"
                        size="sm"
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-muted-foreground mt-0.5">
                            Get a full copy of your profile, bookings, messages,
                            payments, and activity history in a ZIP file.
                          </p>
                        </div>
                      </div>
                      <Button
                ...
                <Card className="p-5 border-0 shadow-sm border-red-200/50 dark:border-red-900/20">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Once deleted, this action cannot be undone. All your
              ...
              <Card className="border-0 shadow-sm overflow-hidden">
                {[
                  ...
                  return (
                    <button
                      key={item.title}
                      className="w-full flex items-center justify-between p-4 hover:bg-muted/30 transition-colors border-b border-border/30 last:border-b-0"
                    >
                      <div className="flex items-center gap-3">
          ...
          <div className="text-center">
            ...
            {(isDownloading || downloadReady) && (
              <div className="mb-5">
                ...
                <p className="text-xs text-muted-foreground">
                  {Math.min(Math.round(downloadProgress), 100)}% complete
                </p>
              </div>
            )}
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="flex gap-2 mb-4">
            {[1, 2, 3].map((s) => (
              <div
                key={s}
                className={`flex-1 h-1 rounded-full transition-colors ${s <= deleteStep ? "bg-red-500" : "bg-muted"}`}
              />
            ))}
          </div>
            ...
            <div>
              ...
              <div className="bg-red-50 dark:bg-red-900/10 rounded-xl p-4 mb-4">
                ...
                <ul className="space-y-1">
                  {[
                    "All personal data and profile",
                    "Booking and payment history",
                    "Wallet balance (KES 5,000)",
                    "Reviews and ratings",
