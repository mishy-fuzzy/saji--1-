  ...
  const handleUseCurrentLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        setFormAddress(`Current location (${latitude.toFixed(5)}, ${longitude.toFixed(5)})`)
      },
      () => {
        ...
        <Dialog open={showForm} onOpenChange={setShowForm}>
          <DialogContent className="max-w-md rounded-2xl" aria-describedby={undefined}>
            ...
            <div className="space-y-4 py-2">
              ...
              <Button onClick={handleUseCurrentLocation} variant="outline" className="w-full rounded-xl bg-transparent gap-2"><Navigation className="w-4 h-4" />Use Current Location</Button>
            </div>
