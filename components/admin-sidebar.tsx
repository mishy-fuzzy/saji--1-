...
export function AdminSidebar({ isHidden = false }: AdminSidebarProps) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "Jobs",
      href: "/admin/jobs",
      badge: badgeCounts.jobs,
    },
    {
      icon: AlertTriangle,
      label: "Disputes",
      href: "/admin/disputes",
      badge: badgeCounts.disputes,
    },
    {
      icon: CreditCard,
      label: "Payments",
  ...
  return (
    <>
      ...
      <aside
        className={`
        fixed top-0 left-0 h-screen bg-linear-to-b from-blue-600 to-blue-800 text-white
        transform transition-all duration-300 z-40 flex flex-col
        ${isHidden ? "lg:w-0 lg:opacity-0 lg:pointer-events-none" : "lg:w-64"}
        ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}
        lg:relative lg:transform-none overflow-hidden
      `}
      >
        {/* Logo Section */}
        <div className="p-4 border-b border-blue-400/30 shrink-0">
        ...
        {/* Footer Section */}
        <div className="p-4 border-t border-blue-400/30 shrink-0 space-y-2">
          ...
          <p className="text-[11px] text-blue-100/80 px-1">
            Use profile menu to log out
          </p>
        </div>
      </aside>
