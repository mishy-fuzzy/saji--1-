...
export default function ProviderWalletPage() {
  ...
  const percentChange = (
    ((walletData.thisMonth - walletData.lastMonth) / walletData.lastMonth) *
    100
  ).toFixed(1);
  ...
  const handleWithdraw = () => {
    ...
    const methodName =
      withdrawMethods.find((m) => m.id === withdrawMethod)?.name || "M-Pesa";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-right">
              <div className="flex items-center gap-1 text-emerald-100 text-sm mb-1">
                <TrendingUp className="w-4 h-4" />+{percentChange}%
              </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
              ...
              <p className="text-lg font-bold">
                {showBalance ? formatCurrency(walletData.escrow) : "****"}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                  ...
                  <p className="text-xl font-bold text-emerald-700 dark:text-emerald-300">
                    {formatCurrency(walletData.thisMonth)}
                  </p>
                </div>
            ...
            <Card className="p-5 border-0 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  onClick={() => alert("Open add payment method dialog")}
                  variant="ghost"
                  size="sm"
            ...
            <Card className="p-4 border-0 shadow-sm">
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <Button
                    onClick={() => alert("Show all transactions")}
                    size="sm"
                    variant="outline"
                  >
                    All
                  ...
                  <Button
                    onClick={() => alert("Show income transactions")}
                    size="sm"
                    variant="ghost"
                  >
                    Income
                  ...
                  <Button
                    onClick={() => alert("Show expense transactions")}
                    size="sm"
                    variant="ghost"
                  >
                    Expenses
                ...
                <Button
                  onClick={() => alert("Open advanced filter options")}
                  size="sm"
                  variant="outline"
                >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    ...
                    by both parties. This protects you and ensures payment for
                    your work.
                  </p>
                </div>
              </div>
            ...
            {escrowPayments.length === 0 ? (
              <Card className="p-8 text-center border-0 shadow-sm">
                ...
                <p className="text-sm text-muted-foreground">
                  Funds will appear here when clients pay for jobs
                </p>
              </Card>
            ) : (
